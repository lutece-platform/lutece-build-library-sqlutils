...
public class SqlPathInfoTest
{
    public static void main(String[] args)
    {
        final String[] files = new String[] { "sql/plugins/testpourliquibase/plugin/create_db_testpourliquibase.sql",
                ...
                "sql/plugins/forms/modules/template/plugin/create_db_forms-template.sql", "sql/plugins/contact/upgrades/update_db_contact-2.0.12-2.0.13.sql",
